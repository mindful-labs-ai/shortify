...
### 캐스트 보조 팔레트 (Cast-only, v1.1)

5인 캐스트([character/03-cast](../character/03-cast.md)) 중 Vera / Sage 의 메인 컬러. **앱 UI 본편에서는 사용하지 않고**, 영상 / 캐릭터 카드 / 마케팅 자산에 한정.

| 토큰 | HEX | 사용 캐릭터 |
|------|-----|--------------|
| `cast-lavender-500` | `#B69CE8` | Vera (52세, ESFJ) |
| `cast-warm-gray-500` | `#8B7E72` | Sage (71세, ISTP) |

> 셰이드(`50` / `900`)는 후속 작업에서 정의.
...
| 날짜 | 작성자 | 변경 |
|------|--------|------|
| 2026-04-26 | 김성곤 | Character Cast v1.1 반영 — `cast-lavender-500 #B69CE8` (Vera), `cast-warm-gray-500 #8B7E72` (Sage) 신설 (영상/카드 한정) |
